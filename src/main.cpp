...
// uint8_t deveui[] = { 0x1C, 0xF7, 0xF1, 0xC0, 0x43, 0x20, 0x00, 0x25 };
// uint8_t appeui[] = { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x09 };
// uint8_t appkey[] = { 0x64, 0xD4, 0x49, 0x27, 0xCD, 0x20, 0x48, 0xE0, 0x92, 0x84, 0x2A, 0x53, 0x84, 0x3A, 0xEC, 0xA5 };
...
unsigned char Other_sensor[11] = {0x41, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
unsigned char VisionAI_data1[11] = {0x42, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
unsigned char VisionAI_data2[11] = {0x43, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
...
void read_sensor()
{
  ...
  //int data3[5] = {};
  // for(int i = 0; i<5;i++) Serial.print(data[i],HEX);
  // Serial.println();
  data_decord(data1, Built_in);
  data_decord(data2, Other_sensor);
  // for(int i = 0; i<11;i++) Serial.print(Built_in[i],HEX);
  // Serial.println();
}
