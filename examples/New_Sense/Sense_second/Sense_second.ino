...
void Sound_Display(int _sound)
{
    ...
    spr.setTextColor(TFT_WHITE);
    spr.drawNumber(_sound, 0, 2 * FONT_ROW_HEIGHT, GFXFF);
    spr.pushSprite(10, 3.8 * FONT_ROW_HEIGHT);
    spr.deleteSprite();
}

void IMU_Display(float _x, float _y, float _z)
{
    ...
    spr.setTextColor(TFT_WHITE);
    spr.drawFloat(_x, 2, 10, 2.5 * FONT_ROW_HEIGHT, GFXFF); // Display the value of IMU X-axis
    spr.drawFloat(_y, 2, 10, 3.5 * FONT_ROW_HEIGHT, GFXFF); // Display the value of IMU Y-axis
    spr.drawFloat(_z, 2, 10, 4.5 * FONT_ROW_HEIGHT, GFXFF); // Display the value of IMU Z-axis
    spr.setFreeFont(FSS9);
